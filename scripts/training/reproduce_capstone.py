...
def main() -> int:
    ...
    _run([sys.executable, str(ROOT / "scripts" / "data" / "build_dataset_manifest.py"), "--dataset-dir", str(args.data_dir)])
    _run([sys.executable, str(ROOT / "scripts" / "training" / "train_and_evaluate.py"), "--data-dir", str(args.data_dir), "--seed", str(args.seed), "--epochs", str(args.epochs)])
    _run([sys.executable, str(ROOT / "scripts" / "training" / "run_capstone_evaluation.py"), "--data-dir", str(args.data_dir), "--seed", str(args.seed), "--out-dir", str(run_dir / "eval")])
